             ...
             <div className="flex items-start gap-3 md:gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className="w-full border-blue-500/30 hover:bg-blue-500 hover:text-white hover:border-blue-500"
                    asChild
                  >
                    <a
             ...
             <div className="flex items-start gap-3 md:gap-4">
                ...
                <div className="flex-1">
                  ...
                  <Button 
                    variant="outline" 
                    size="sm" 
                    className="w-full border-orange-500/30 hover:bg-orange-500 hover:text-white hover:border-orange-500"
                    asChild
                  >
                    <a
